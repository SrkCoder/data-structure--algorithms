...
public:
    int reg,product;
    string brand,model,type,condition;
    long price;
    Node* next;
};
class Car {
...
public:
    ...
    void insertcar(int reg,string model,string brand,string type,string condition,long price) {
...
start:
    ...
    case 1:
        ...
        cout<<"Enter car type (family,personal) \n";
        cin>>type;
        cout<<"Enter car type (new,old) \n";
        cin>>condition;
        cout<<"Enter car price (in digits) \n";
        cin>>price;
        list.insertcar(reg, model, brand,type, condition,price);
        goto start;
    case 2:
        count++;
        reg=count;
